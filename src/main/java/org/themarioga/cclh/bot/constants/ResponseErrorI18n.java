...
public class ResponseErrorI18n {
    ...
    public static final String GAME_NOT_FILLED = "La partida aun no ha llegado al numero minimo de jugadores.";
    public static final String GAME_NOT_STARTED = "La partida aun no se ha iniciado.";

    public static final String PLAYER_NO_GAMES = "No tienes ninguna partida activa.";
    public static final String PLAYER_ALREADY_PLAYING = "Ya estas participando en una partida.";
